        ...
        <nav
            ...
            <div class="flex items-center justify-between">
                ...
                <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
                    href="/" aria-label="Nepal Prices">
                    <img src="https://avatars.githubusercontent.com/u/175485634?s=200&v=4" class="h-12 w-12 rounded-lg"
                        alt="Nepal Prices Logo">
                </a>
                <!-- End Logo -->
            ...
            <div id="hs-navbar-floating-dark"
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7">
                    ...
                    <a class="p-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                        href="/fuel-prices">Fuel</a>
                    <a class="p-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                        href="bike-prices">Bikes</a>
                    <a class="p-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                        href="car-prices">Car</a>
                    <a class="p-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                        href="vegetable-prices">Vegetable</a>
                    <a class="p-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                        href="gold-prices">Gold</a>

                    <div>
                        <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#b10502] font-medium text-sm text-white-800 rounded-full focus:outline-none"
                            href="https://play.google.com/store/apps/details?id=com.pricesnepalorg.pricesnepal"
                            target="_blank">
                            Download App
                        </a>
                    </div>
