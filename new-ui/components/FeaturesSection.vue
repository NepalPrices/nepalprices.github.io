    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-neutral-200 mb-8">
                    Get Latest Prices in Nepal
                </h2>
            </div>
            <!-- End Title -->
            <!-- Grid -->
            <div class="grid md:grid-cols-2 gap-6 lg:gap-12">
                <div class="space-y-6 lg:space-y-10">
                    ...
                    <!-- Icon Block -->
                    <div class="flex gap-x-5 sm:gap-x-8">
                        <svg class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white"
                        ...
                        <div class="grow">
                            ...
                            <p class="mt-1 text-gray-600 dark:text-neutral-400">
                                Benefit from automatic updates to all boards any time you need to make a change to your
                                website.
                            </p>
                        </div>
                    </div>
